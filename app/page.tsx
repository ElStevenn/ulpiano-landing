...
function ProductHero() {
  return (
    <section className="relative isolate w-full min-h-[80vh] md:min-h-[92vh] lg:min-h-screen flex items-center overflow-hidden text-white" style={{ background: '#030712' }}>
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 w-full pt-28 md:pt-32 lg:pt-36 pb-12 md:pb-16 lg:pb-20">
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-16 items-center">
          {/* ===== LEFT COLUMN — Message ===== */}
          <div className="relative flex flex-col items-start max-w-[580px]">
            ...
            <motion.h1
              ...
              className="relative text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-6xl font-bold tracking-tight leading-[1.08] mb-6"
            >
            ...
            <motion.p
              ...
              className="text-base md:text-lg text-white/55 leading-relaxed max-w-[500px] mb-8"
            >
            ...
            >
              ...
              <div className="text-sm">
                <span className="text-white/90 font-medium">+150 despachos</span>
                <span className="text-white/40 ml-1">confían en Ulpiano</span>
              </div>
            </motion.div>
          </div>
...
function KeyBenefits() {
  ...
  return (
    <section className="relative isolate full-bleed overflow-x-hidden py-16 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
