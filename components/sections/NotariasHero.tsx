...
export default function NotariasHero() {
            ...
            >
              ...
              <div>
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.5rem] font-bold tracking-tight leading-[1.05] text-white mb-6">
                  <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent">
                    Optimiza cada trámite sucesorio
                  </span>
                  <br />
                  <span className="text-white">
                    y ofrece a tus clientes una experiencia moderna
                  </span>
                </h1>
              </div>
              ...
              <div>
                <p className="text-base md:text-xl text-white/60 leading-relaxed font-light mb-8">
                  Con ulpiano.es, las notarías simplifican la elaboración de
                  documentos, minimizan errores y ganan tiempo para dedicarse al
              ...
              <div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Agregación del Patrimonio y Árbol Familiar
                      </h3>
                      <p className="text-white/70 text-sm">
                        Recopilación de datos, registro de bienes, deudas y
                        legitimarios. Visualización de relaciones familiares y
                        respeto de cuotas forzosas y legítimas.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Atribuciones y Visualización Fiscal
                      </h3>
                      <p className="text-white/70 text-sm">
                        Reportes de atribución claros y simulación instantánea
                        de impuestos de sucesiones con escenarios de ahorro y
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Creación de Documentos Automatizada con IA
                      </h3>
                      <p className="text-white/70 text-sm">
                        Generación de testamentos, escrituras de aceptación y
                        otros borradores listos para validación mediante IA.
                        Firma y registro agilizados.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      id="jobTitle"
                      type="text"
                      placeholder="Notario, Abogado, etc."
                      className="mt-1 bg-white/90 border-0 text-gray-900 placeholder:text-gray-500"
                    />
                  </div>
