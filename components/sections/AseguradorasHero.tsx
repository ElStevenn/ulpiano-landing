...
export default function AseguradorasHero() {
  return (
            ...
            <div className="space-y-8">
              <AnimatedSection className="fade-in-up delay-100">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-[1.15] text-white">
                  <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent">
                    Aporta Valor Añadido a Tus Clientes
                  </span>
                  <br />
                  <span className="text-white">
                    con Soluciones de Planificación Sucesoria
                  </span>
                </h1>
              </AnimatedSection>
              ...
              <AnimatedSection className="fade-in-up delay-200">
                <p className="text-lg text-gray-300 leading-relaxed">
                  ulpiano.es ayuda a las aseguradoras a ampliar su catálogo de
                  productos, ofreciendo la gestión y tramitación de herencias de
                  forma digital y segura.
                </p>
              </AnimatedSection>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Complemento Ideal a Pólizas de Vida y Decesos
                      </h3>
                      <p className="text-white/70 text-sm">
                        Servicio post-fallecimiento que facilita los trámites de
                        herencia y liquidación del Impuesto de Sucesiones,
                        reduciendo la carga para las familias.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Gestión digital de expedientes, control en vivo y
                        simulaciones de impuestos para ofrecer un servicio
                        integral.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Visibilidad completa del proceso y menor estrés en
                        momentos delicados, apoyando a asegurados y sus
                        familias.
                      </p>
                    </div>
                  </div>
