...
export default function FamilyOfficeHero() {
  return (
            ...
            <div className="space-y-8">
              <AnimatedSection className="fade-in-up delay-100">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-[1.15] text-white">
                  <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent">
                    Preserva y Transfiere el Legado
                  </span>
                  <br />
                  <span className="text-white">
                    de tus clientes con Herramientas Digitales de Vanguardia
                  </span>
                </h1>
              </AnimatedSection>
              ...
              <AnimatedSection className="fade-in-up delay-200">
                <p className="text-lg text-gray-300 leading-relaxed">
                  ulpiano.es ayuda a Family Offices a coordinar la planificación
                  sucesoria, optimizar los impuestos y ofrecer transparencia en
                  la gestión de bienes y estructuras complejas.
                </p>
              </AnimatedSection>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Consolidación de activos, análisis y reportes detallados
                        para múltiples herederos y jurisdicciones.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Simulación y optimización de impuestos, gestión de
                        beneficiarios y verificación de cumplimiento normativo.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Control, Transparencia y Confidencialidad
                      </h3>
                      <p className="text-white/70 text-sm">
                        Dashboard exclusivo con acceso limitado por roles y
                        protección de datos sensibles con cifrado de nivel
                        bancario.
                      </p>
                    </div>
                  </div>
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="tu@familyoffice.es"
                      className="mt-1 bg-white/90 border-0 text-gray-900 placeholder:text-gray-500"
                    />
                  </div>
