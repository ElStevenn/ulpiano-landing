...
export default function FunerariasHero() {
            ...
            >
              ...
              <div>
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.5rem] font-bold tracking-tight leading-[1.05] text-white mb-6">
                  ...
                  <br />
                  <span className="text-white">Más Allá del funeral</span>
                </h1>
              </div>

              <div>
                <p className="text-base md:text-xl text-white/60 leading-relaxed font-light mb-8">
                  Con ulpiano.es, amplía la oferta de la funeraria, ofreciendo
                  ayuda en la gestión de trámites sucesorios y el asesoramiento
                  en herencias, todo de forma digital y segura.
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-white">
                        Ampliación del Servicio Tradicional
                      </h3>
                      <p className="text-white/70 text-sm">
                        Integra la planificación y tramitación de herencias,
                        brindando tranquilidad a las familias en un momento
                        delicado.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Gestión digital de documentos, cálculo de impuestos y
                        supervisión en tiempo real para simplificar los trámites
                        sucesorios.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">
                        Ahorro de tiempo para la familia y transparencia en cada
                        paso, permitiendo que las personas se centren en su
                        duelo.
                      </p>
                    </div>
                  </div>
